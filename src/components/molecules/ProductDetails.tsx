...
import { IconButton, Rating, Typography, Button } from '@mui/material';
    ...
    return (
        <Container>
            ...
            <InfoContainer>
                ...
                <Typography variant='h4' color={'#4256ac'} fontWeight={'bold'} marginTop={5} align="center">S/.800.00</Typography>
                <ButtonsContainer>
                    <Button
                        variant='contained'
                        size="medium"
